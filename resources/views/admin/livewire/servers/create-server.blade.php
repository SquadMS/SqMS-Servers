    ...
    <x-sqms-foundation::dialog-modal wire:model="showModal" class="fs-base">
        ...
        <x-slot name="content">
            ...
            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{ $server->account_playtime ? 'checked' : '' }} wire:click="$toggle('server.account_playtime')" value="1">
